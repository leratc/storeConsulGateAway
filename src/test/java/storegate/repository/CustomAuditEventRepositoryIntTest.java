package storegate.repository;

import storegate.StoreConsulGateAwayApp;
import storegate.config.Constants;
import storegate.config.audit.AuditEventConverter;
import storegate.domain.PersistentAuditEvent;
...
import static storegate.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
